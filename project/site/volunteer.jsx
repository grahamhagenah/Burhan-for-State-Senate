...
function VolAside() {
  ...
  return (
    <div className="vol-aside">
      <div className="vol-portrait" style={{ backgroundImage: "url(assets/burhan-portrait-cutout.png)", backgroundColor: "#215BBE", backgroundPosition: "center -10px", backgroundSize: "auto 320px", backgroundRepeat: "no-repeat" }} />
      <div className="vbox">
